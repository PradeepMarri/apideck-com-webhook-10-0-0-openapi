...
func WebhooksexecuteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/webhook/webhooks/%s/execute/%s", cfg.BaseURL, id, serviceId)
...
func CreateWebhooksexecuteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_webhook_webhooks_id_execute_serviceId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    WebhooksexecuteHandler(cfg),
	}
}
