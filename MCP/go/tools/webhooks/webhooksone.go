...
func WebhooksoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetWebhookResponse
...
func CreateWebhooksoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_webhook_webhooks_id",
		mcp.WithDescription("Get webhook subscription"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    WebhooksoneHandler(cfg),
	}
}
